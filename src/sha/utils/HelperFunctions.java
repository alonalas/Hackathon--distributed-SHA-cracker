...
public class HelperFunctions {
	...
	public static boolean isValidHash(String hash) {
	    return hash.matches("[a-fA-F0-9]+") && hash.length() == 40;
	}
    ...
    public static void main(String[] args) {
    	...
    	// random string with length 4 takes less then 10 seconds to crack -> we used 81fe8bfe87576c3ecb22426f8e57847382917acf for testing protocol flow.
    	String toHash = "abcd";
